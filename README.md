...
Then open the configured Dokploy domain for `hermes-workspace`, or access it through Dokploy's internal routing on container port `3000`.

Notes:
- `hermes-workspace` is exposed internally on port `3000` for Dokploy/Traefik routing
